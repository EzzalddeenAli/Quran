...
public class Search_ListView extends ArrayAdapter<SearchListObjects> {
    LayoutInflater getInflater = null;
    Context context;
    SearchListObjects[] data = null;
    boolean playing = false;
    MediaPlayer mp = null;
    int[] disPic;
    ArrayList<Integer> lastPos = new ArrayList<Integer>();

    public Search_ListView(Context context, LayoutInflater getLayoutInflater, SearchListObjects[] searchListObjects) {
    ...
    @Override
    public SearchListObjects getItem(int position) {
        return super.getItem(position);
    }

    @Override
    public int getPosition(SearchListObjects item) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final SearchListObjects listObjects = super.getItem(position);
