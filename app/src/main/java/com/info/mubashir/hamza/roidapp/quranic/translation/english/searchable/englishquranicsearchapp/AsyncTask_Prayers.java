...
public class AsyncTask_Prayers extends AsyncTask<String, String, String> {
    ...
    public class PrayObjects {
        public String prayerDay;
        public String prayerFajr;
        public String prayerDhuhr;
        public String prayerAsr;
        public String prayerMaghrib;
        public String prayerIsha;
    ...
    private void slowlyFillViews() {
        ...
        if (z < prayObjects.length) {
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    tv_day[z].setText(prayObjects[z].prayerDay);
                    tv_fajr[z].setText(prayObjects[z].prayerFajr);
                    tv_dhuhr[z].setText(prayObjects[z].prayerDhuhr);
                    tv_asr[z].setText(prayObjects[z].prayerAsr);
                    tv_maghrib[z].setText(prayObjects[z].prayerMaghrib);
                    tv_isha[z].setText(prayObjects[z].prayerIsha);
