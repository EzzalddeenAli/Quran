...
public class Search_ListView extends ArrayAdapter<Async_Search.SearchListObjects> {
    LayoutInflater getInflater = null;
    Context context;
    Async_Search.SearchListObjects[] data = null;
    ...
    public Search_ListView(Context context, LayoutInflater getLayoutInflater, Async_Search.SearchListObjects[] searchListObjects, int exp_num) {
        super(context, android.R.layout.simple_list_item_single_choice, searchListObjects);
        this.getInflater = getLayoutInflater;
        this.context = context;
        this.data = searchListObjects;
        this.EXPANSION_NUMBER = exp_num;
        this.disPic = new int[searchListObjects.length];

        for (int x = 0; x < searchListObjects.length; x++) {
            disPic[x] = 0;
        }
    }
    ...
    @Override
    public Async_Search.SearchListObjects getItem(int position) {
        return super.getItem(position);
    }

    @Override
    public int getPosition(Async_Search.SearchListObjects item) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final Async_Search.SearchListObjects listObjects = super.getItem(position);
                ...
                holder.book.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (listObjects.bookmarks_chapter == 1) {
                            ...
                            listObjects.bookmarks_chapter = 0;
                            notifyDataSetChanged();
                        } else if (listObjects.bookmarks_chapter == 0) {
                            viewToastCustom(R.string.bookmark_saved_string, font_style);
                            dbConnectUpdater(true, listObjects.rowid_number);
                            listObjects.bookmarks_chapter = 1;
                            notifyDataSetChanged();
                        }
                    }
                });
